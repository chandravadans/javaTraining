...
import student.filehandling.persistence.CompanyPersister;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// TODO: Uncomment one of the following statements, to read-in company data.
		...
		// TODO: Uncomment one of the following statements, to write-out company data.
	...
	public static Company deserializeCompany(String filename) {
		...
		// TODO (in exercise 2): Implement this method, to deserialize a Company (and its employees, implicitly).
	...
	public static void serializeCompany(String filename, Company company) {
		...
		// TODO (in exercise 2): Implement this method, to serialize a Company (and its employees, implicitly).
